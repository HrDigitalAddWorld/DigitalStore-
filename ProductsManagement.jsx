...
const ProductsManagement = () => {
  ...
  const subcategories = {
  Electronics: ["Mobile", "TV", "Laptops", "Books", "Fashion", "Computer"],
  "Home-kitchen": ["Cookware", "Serveware", "Storage", "Cleaning"],
  Grocery: ["Beverages", "Snacks", "Grains", "Spices"],
  Fashion: ["Men", "Women", "Kids"],
  "Beauty-personal-care": ["Skin Care", "Hair Care", "Makeup"],
  "Sports-fitness": ["Gym", "Outdoor", "Accessories"]
};
...
>
  ...
  {subcategories[newProduct.category]?.map((sub, index) => (
